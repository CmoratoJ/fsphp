...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2021-05-01T13:32:15-03:00+170463">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-instagram" href="www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>" title="CafeControl no YouTube">/CafeControl</a>
            </article>
        </section>
    </div>
</footer>
